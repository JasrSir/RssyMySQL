...
import static jasrsir.com.rssmysql.HomeActivity.MAIL;
import static jasrsir.com.rssmysql.R.id.recyclerView;
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                if (result != null)
                    if (result.getCode()) {
                        ...
                        //s = gson.fromJson(String.valueOf(result.getSites()), Site.class);
                        Intent i = new Intent();
